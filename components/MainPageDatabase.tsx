                ...
                {recentSends.map((send: SendWithClimb, i: number) => {
                  ...
                  return (
                    ...
                    <Link
                      key={send.id}
                      href={`/database/${c.id}-${c.slug}`}
                      className={`grid grid-cols-[64px_1fr_75px] sm:grid-cols-[64px_1fr_90px_90px_50px] gap-3.5 px-4 py-4 items-center hover:bg-[rgba(244,241,236,0.04)] transition-colors ${
                        i < recentSends.length - 1
                          ? "border-b border-[rgba(244,241,236,0.08)]"
                          : ""
                      }`}
...
//                       key={send.id}
//                       href={`/database/${c.id}-${c.slug}`}
//                       className={`grid grid-cols-[64px_1fr_50px] md:grid-cols-[64px_1fr_90px_90px_50px] gap-3.5 px-4 py-4 items-center hover:bg-[rgba(244,241,236,0.04)] transition-colors ${
//                         i < recentSends.length - 1
//                           ? "border-b border-[rgba(244,241,236,0.08)]"
//                           : ""
//                       }`}
...
//                         </MonoChip>
//                       </div>
//                       <MonoChip className="hidden md:block text-[rgba(244,241,236,0.55)]">
//                         {formatDate(send.created_at)}
//                       </MonoChip>
//                       <div className="hidden md:flex items-center gap-1.5 text-[rgba(244,241,236,0.55)]">
//                         <TypeGlyph
//                           type={c.type}
//                           size={12}
//                           className="hidden sm:block"
